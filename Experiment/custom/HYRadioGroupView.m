...
- (void)mSetUpUIWithProblem:(NSDictionary*)problem title:(NSString*)title
{
    ...
    for (int i=0;i<4;i++) {
        ...
        [optBtn setImage:[UIImage imageNamed:@"selection_box"] forState:UIControlStateSelected];
        [optBtn setImage:[UIImage imageNamed:@"selection_box_1"] forState:UIControlStateNormal];
